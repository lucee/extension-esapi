...
/**
 * IMPORTANT: Decoding user input is generally NOT recommended for security purposes. Modern
 * security practices focus on encoding OUTPUT, not decoding input.
 * 
 * This class is provided for legitimate use cases like processing already-encoded data, but should
 * NOT be used as a security measure to "sanitize" user input.
 */
public class ESAPIDecode extends FunctionSupport {
	 ...
	 * 
	 * NOTE: This is a simplified implementation that handles common entities. ESAPI's implementation is
	 * more comprehensive but requires heavy dependencies.
	 */
