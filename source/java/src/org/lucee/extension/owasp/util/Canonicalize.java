...
/**
 * Lightweight Canonicalization Alternative
 * 
 * This is a SIMPLIFIED version of ESAPI's canonicalize functionality.
 * It only handles URL and HTML decoding (the most common cases).
 */
...
public class Canonicalize {
	 ...
	 */
	public static String canonicalize(String input, boolean throwOnMultiple) throws Exception {
	...
	/**
	 * Decode common HTML entities This is NOT comprehensive - ESAPI's HTMLEntityCodec handles hundreds
	 * of entities
	 */
	...
	/**
	 * Decode numeric HTML entities like &#60; or &#x3C; This is a simplified version - ESAPI handles
	 * all Unicode ranges
	 */
