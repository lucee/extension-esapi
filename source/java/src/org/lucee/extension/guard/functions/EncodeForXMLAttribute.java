...
public class EncodeForXMLAttribute  extends FunctionSupport {
	...
	public static String call(PageContext pc , String item, boolean canonicalize)  throws PageException  {
		return GuardEncode.encode(item, GuardEncode.ENC_XML_ATTR,canonicalize);
	}
	...
	public Object invoke(PageContext pc, Object[] args) throws PageException {
		...
		throw exp.createFunctionException(pc, "EncodeForXMLAttribute", 1, 2, args.length);
	}
}